...
from dev_kit.schemas.enums import (
    ...
    ANTHROPIC_MODELS, OPENAI_MODELS, OLLAMA_MODELS, GOOGLE_MODELS, ALL_CHAT_MODELS, LANGUAGES,
...
def test_all_chat_models_is_union():
    assert set(ALL_CHAT_MODELS) == set(ANTHROPIC_MODELS) | set(OPENAI_MODELS) | set(OLLAMA_MODELS) | set(GOOGLE_MODELS)
