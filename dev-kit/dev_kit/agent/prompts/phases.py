...
def get_phase_addition(phase: str, available_tools: list[str] | None = None) -> str:
    ...
    if phase == "language":
        return (
            ...
            "- **cli** — configure if cli is in selected_channels. Plain text, no markdown:\n"
    ...
    if phase == "workflow":
        ...
        return (
            ...
            "- **Before finishing this phase:** collect every intent in `global_intents` and "
            "every intent in every subagent's `valid_intents`. If ANY intent appears in both "
            "lists, remove it from `global_intents` — subagent-level routing takes precedence "
            "and the overlap will crash Agent Core at startup.\n\n"
    ...
    if phase == "reach":
        return (
            ...
            "- Verify `reach_layer.channels.web` has `auth.enabled`, `ui.*` branding fields set.\n"
