...
Implements TrustLayerBase. All error handlers are fail-closed:
  ...
  assemble_constraints: return empty constraints dict
...
class TrustLayerHttpClient(TrustLayerBase):
    ...
    def assemble_constraints(
        ...
        """Call POST /assemble_constraints. Returns empty constraints on any failure.
        ...
        Returns:
            ...
            and refusal_templates. Returns empty structure on failure.
        ...
        try:
            ...
            return dict(_EMPTY_CONSTRAINTS)  # fail-safe: empty constraints
